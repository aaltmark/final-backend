...
# 40.times do 
#     Instructor.create(name: Faker::Name.name, phone: 9877877654, date_of_birth: Faker::Date.between(from: '1970-09-23', to: '1996-09-25'), email: Faker::Internet.email, specialty: "ski", group_size: rand(6), group_age: "All", group_skill: "All", image: "https://www.skiutah.com/media-room/Press-Room/index.html/Anelise-Bergin-Headshot-MediaPage-500wX644h.jpg", years_experience: rand(15), certification: true, bio: Faker::TvShows::SouthPark.quote, hometown: Faker::Address.city)
# end 

#ignore this one 
# 300.times do 
#     InstructorResort.create(instructor_id: rand(42), resort_id: rand(459))
# end 
...
# range.map{|day| Schedule.create(instructor_id: 1, date: day, day_of_week: Date::DAYNAMES[day.wday], early_am: true, mid_am: true, early_pm: true, late_pm: true)}
...
schedules = [
    ...
    {date: "Fri Sep 11 2020", available: true, instructor_id: 1},
